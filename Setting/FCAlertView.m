...
- (void)drawRect:(CGRect)rect {
    ...
    if (_numberOfButtons == 0) { // View only contains DONE/DISMISS Button
        ...
        doneButton.titleLabel.font = [UIFont systemFontOfSize:18.0f];
        ...
        firstButton.titleLabel.font = [UIFont systemFontOfSize:16.0f];
        ...
        secondButton.titleLabel.font = [UIFont systemFontOfSize:16.0f];
