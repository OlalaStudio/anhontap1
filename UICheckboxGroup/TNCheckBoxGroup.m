...
- (void)checkBoxDidChange:(TNCheckBox *)checkbox {
    ...
    for (TNCircularCheckBox *cbitem in [self subviews]) {
        cbitem.data.checked = NO;
        cbitem.data.borderColor = [UIColor blackColor];
        cbitem.data.circleColor = [UIColor blackColor];
        [cbitem checkWithAnimation:YES];
    }
    
    TNCircularCheckBox *checkedbox = (TNCircularCheckBox*)checkbox;
    
    checkedbox.data.checked = YES;
    checkedbox.data.circleColor = [UIColor orangeColor];
    checkedbox.data.borderColor = [UIColor orangeColor];
    [checkedbox checkWithAnimation:YES];
}
